...
export function StrongCta() {
  ...
  return (
    <section className="relative overflow-hidden py-9 md:py-[60px]" style={{ background: "#080808" }}>
      ...
      <div className="container mx-auto px-4 md:px-6 relative" style={{ zIndex: 1 }}>
        <div className="flex justify-center">
          <motion.div
            ...
            style={{ maxWidth: "760px", width: "100%", padding: "clamp(40px, 6vw, 64px) clamp(24px, 5vw, 64px)", background: "linear-gradient(145deg, rgba(255,255,255,0.038) 0%, rgba(255,255,255,0.012) 100%)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", border: "1px solid rgba(212,175,55,0.18)", borderRadius: "24px", boxShadow: "inset 0 1px 0 rgba(255,255,255,0.06), 0 0 0 1px rgba(212,175,55,0.06), 0 24px 80px rgba(0,0,0,0.4)" }}
          >
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} style={{ marginBottom: "20px" }}>
              <motion.span
            ...
            <motion.h2
              ...
              style={{ fontSize: "clamp(28px, 4.5vw, 52px)", fontWeight: 700, color: "#ffffff", lineHeight: 1.18, letterSpacing: "-0.5px", marginBottom: "20px", textShadow: "0 0 60px rgba(212,175,55,0.12)" }}
            >
              {t.cta_heading_1}
              <br />
              <span style={{ color: "#D4AF37" }}>{t.cta_heading_2}</span>
            </motion.h2>
            ...
            >
              <motion.button
                ...
                style={{ padding: "15px 38px", fontSize: "11px", fontWeight: 700, letterSpacing: "2px", textTransform: "uppercase", background: "#D4AF37", color: "#0B0B0B", border: "none", borderRadius: "8px", cursor: "pointer", boxShadow: "0 0 28px rgba(212,175,55,0.25)", transition: "background 0.25s ease" }}
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                transition={{ duration: 0.25 }}
                style={{ padding: "15px 38px", fontSize: "11px", fontWeight: 700, letterSpacing: "2px", textTransform: "uppercase", background: "transparent", color: "#D4AF37", border: "1px solid rgba(212,175,55,0.4)", borderRadius: "8px", cursor: "pointer", transition: "border-color 0.25s ease, background 0.25s ease, box-shadow 0.25s ease" }}
                onMouseEnter={e => { e.currentTarget.style.background = "rgba(212,175,55,0.07)"; e.currentTarget.style.borderColor = "rgba(212,175,55,0.75)"; e.currentTarget.style.boxShadow = "0 0 20px rgba(212,175,55,0.1)"; }}
                onMouseLeave={e => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.borderColor = "rgba(212,175,55,0.4)"; e.currentTarget.style.boxShadow = "none"; }}
              >
                {t.cta_btn_secondary}
              </motion.button>
            </motion.div>
