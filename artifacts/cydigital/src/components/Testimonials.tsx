...
export function Testimonials() {
  ...
  const testimonials = [
    { initials: "ΑΣ", name: "Αντώνης Σταύρου", role: t.t1_role, quote: t.t1_quote, result: t.t1_result },
    { initials: "ΜΧ", name: "Μαρία Χριστοδούλου", role: t.t2_role, quote: t.t2_quote, result: t.t2_result },
    { initials: "ΚΝ", name: "Κώστας Νεοφύτου", role: t.t3_role, quote: t.t3_quote, result: t.t3_result },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {testimonials.map((item, index) => (
            <motion.div
              ...
              whileHover={{ y: -5, borderColor: "rgba(212,175,55,0.55)", boxShadow: "0 0 28px rgba(212,175,55,0.13)" }}
              style={{ background: "#111111", border: "1px solid rgba(212,175,55,0.15)", borderRadius: "14px", padding: "32px", display: "flex", flexDirection: "column", gap: "0", transition: "border-color 0.3s ease, box-shadow 0.3s ease", cursor: "default" }}
            >
